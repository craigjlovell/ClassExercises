...
namespace ChessGame
{
    class ChessBoard
    {
        ...
        public ChessBoard()
        {
            ...
            board[0, 1] = new ChessPieceRook(this, EChessSide.WHITE, 0, 1);
            ...
            board[0, 6] = new ChessPieceRook(this, EChessSide.WHITE, 0, 6);
            ...
            board[7, 1] = new ChessPieceRook(this, EChessSide.BLACK, 7, 1);
            ...
            board[7, 6] = new ChessPieceRook(this, EChessSide.BLACK, 7, 6);
